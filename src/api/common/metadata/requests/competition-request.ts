...
/**
 * GetCompetitionsRequest class for sending request to get competitions
 * from the API. It extends the HttpRequestDto class and contains
 * the properties for the request to get competitions from the API.
 ...
 * @returns GetCompetitionsRequest instance that contains the properties
