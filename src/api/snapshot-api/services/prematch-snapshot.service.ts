 ...
 * the HTTP service.
 */
export class PreMatchSnapshotApiClientImplementation extends BaseHttpClient implements PreMatchSnapshotApiClient {
     ...
     */
     public async getOutrightLeagueMarkets(
      requestDto: GetOutrightLeagueMarketRequestDto,
        ...
        const request = this.mapper.map<GetOutrightLeagueMarketRequestDto, GetOutrightLeagueMarketRequest>(
          requestDto,
          GetOutrightLeagueMarketRequest,
        );
