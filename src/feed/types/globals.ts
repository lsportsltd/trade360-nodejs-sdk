...
export const DEFUALT_NETWORK_RECOVERY_INTERVAL_IN_MS: number = 10 * 1000; // 5 seconds
export const DEFUALT_AUTOMATIC_RECOVERY_ENABLED: boolean = true;
export const DEFUALT_CONSUMPTION_LATENCY_THRESHOLD: number = 60; // 60 seconds
export const DEFUALT_LSPORTS_PROCESSING_LATENCY_THRESHOLD: number = 60; // 60 seconds
...
export const MIN_NETWORK_RECOVERY_INTERVAL_IN_MS: number = 5 * 1000; // 5 seconds
