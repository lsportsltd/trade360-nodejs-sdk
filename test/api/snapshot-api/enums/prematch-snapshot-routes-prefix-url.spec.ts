...
describe('PrematchSnapshotApiClientPrefixUrl Enum', () => {
  it('should have correct route values for all prematch endpoints', () => {
    ...
    expect(PrematchSnapshotApiClientPrefixUrl.GET_FIXTURE_MARKETS_PREFIX_URL).toBe('/Prematch/GetFixtureMarkets');
    expect(PrematchSnapshotApiClientPrefixUrl.GET_FIXTURES_PREFIX_URL).toBe('/Prematch/GetFixtures');
    expect(PrematchSnapshotApiClientPrefixUrl.GET_SCORES_PREFIX_URL).toBe('/Prematch/GetScores');
    expect(PrematchSnapshotApiClientPrefixUrl.GET_OUTRIGHT_EVENT_PREFIX_URL).toBe('/Prematch/GetOutrightEvents');
    expect(PrematchSnapshotApiClientPrefixUrl.GET_OUTRIGHT_FIXTURE_PREFIX_URL).toBe('/Prematch/GetOutrightFixture');
    expect(PrematchSnapshotApiClientPrefixUrl.GET_OUTRIGHT_LEAGUES_PREFIX_URL).toBe('/Prematch/GetOutrightLeagues');
    expect(PrematchSnapshotApiClientPrefixUrl.GET_OUTRIGHT_LEAGUES_MARKETS_PREFIX_URL).toBe('/Prematch/GetOutrightLeagueMarkets');
    expect(PrematchSnapshotApiClientPrefixUrl.GET_OUTRIGHT_LEAGUE_EVENTS_PREFIX_URL).toBe('/Prematch/GetOutrightLeagueEvents');
    expect(PrematchSnapshotApiClientPrefixUrl.GET_OUTRIGHT_FIXTURE_MARKETS_PREFIX_URL).toBe('/Prematch/GetOutrightFixtureMarkets');
    expect(PrematchSnapshotApiClientPrefixUrl.GET_OUTRIGHT_SCORES_PREFIX_URL).toBe('/Prematch/GetOutrightScores');
  });
  ...
  it('should maintain consistent naming pattern for outright endpoints', () => {
    const outrightRoutes = Object.values(PrematchSnapshotApiClientPrefixUrl)
      .filter(route => route.includes('Outright'));
